...
$CONF['setup_password'] = '531cb8943a6e210e9a31dc1cbb5ad9a4:f950e46c86ee3ab25ace4b9dccb9d241cd4afb89';

// Postfix Admin Path
// Set the location of your Postfix Admin installation here.
// YOU MUST ENTER THE COMPLETE URL e.g. http://domain.tld/postfixadmin
$CONF['postfix_admin_url'] = 'localhost/postfixadmin';
...
$CONF['user_footer_link'] = "example.com";
...
// Parameters: (1) username (2) domain
 $CONF['mailbox_postdeletion_script']='/usr/local/bin/sudo -u vscan /usr/local/bin/postfixadmin-mailbox-postdeletion.sh';
...
// prevent the web-server from executing external scripts.
// Parameters: (1) domain
$CONF['domain_postdeletion_script']='/usr/local/bin/sudo -u vscan /usr/local/bin/postfixadmin-domain-postdeletion.sh';
